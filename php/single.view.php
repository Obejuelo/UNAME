...
<body>  
    ...
    <section class="container">
        <div class="row justify-content-center">
            <div class="col-md-9">
                <img src="<?php echo RUTA; ?>/image/noticias/<?php echo $nota['imagen']; ?>" alt="" class="img-fluid img-single">
                <p class="text-right text-info"><?php echo fecha($nota['fecha']); ?></p>
            ...
            <div class="col-9">
                <a href="noticias"><p class="text-right text-info">Regresar</p></a>
            </div>
