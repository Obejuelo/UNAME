                ...
                <div class="row">
                    <div class="columna col-lg-7">
                        <div class="widget nueva_entrada">
                            <h3 class="titulo">Agenda Académica</h3>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="card card-eventos border-success">
                                            ...
                                            <div class="card-body justify-content-center">
                                                ...
                                                <div class="dashboard">
                                                    <a href="borrarEvento?id=<?php echo $nota['id']; ?>" class="text-danger">Eliminar</a>
                                                    <a href="editarEvento?id=<?php echo $nota['id']; ?>">Editar</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
