                ...
                <div class="row">
                    <div class="columna col-lg-7">
                        <div class="widget nueva_entrada">
                            <h3 class="titulo">Editar Noticia</h3>
                            <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" enctype="multipart/form-data" method="post">
                                <input type="hidden" value="<?php echo $nota['id']; ?>" name="id">
                                <input type="text" name="titulo" placeholder="Titulo de la noticia" required value="<?php echo $nota['titulo']; ?>">
                                <textarea name="texto" placeholder="" required=""><?php echo $nota['texto']; ?></textarea>
                                <input type="file" name="imagen" class=""><br>
                                <input type="hidden" name="imagen-guardada" value="<?php echo $nota['imagen']; ?>">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="card card-eventos border-success">
                                            ...
                                            <div class="card-body justify-content-center">
                                                ...
                                                <p class="card-text text-success text-justify"><small><?php echo substr($nota['texto'], 0, 85); ?>..</small></p>
